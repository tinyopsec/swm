...
#define TAGKEYS(KEY,TAG) \
	...
	{ MODKEY|ControlMask, KEY, tglview, {.ui = 1 << TAG} }, \
...
static const K keys[] = {
	...
	{ MODKEY, XK_q, killcl, {0} },
	{ MODKEY|ShiftMask, XK_e, quit, {0} },
	{ MODKEY, XK_j, fcs, {.i = +1} },
	{ MODKEY, XK_k, fcs, {.i = -1} },
	{ MODKEY, XK_i, incnm, {.i = +1} },
	{ MODKEY, XK_o, incnm, {.i = -1} },
	{ MODKEY, XK_h, setmf, {.f = -0.05} },
	{ MODKEY, XK_l, setmf, {.f = +0.05} },
	{ MODKEY, XK_space, zoom, {0} },
	{ MODKEY, XK_Tab, view, {0} },
	{ MODKEY, XK_t, setlt, {.v = &layouts[0]} },
	{ MODKEY, XK_f, setlt, {.v = &layouts[1]} },
	{ MODKEY, XK_m, setlt, {.v = &layouts[2]} },
